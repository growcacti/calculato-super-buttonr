...
class CollatzGUI(tk.Tk):
    ...
    def create_widgets(self):
        # Input for the limit
        self.limit_label = tk.Label(self, text="Enter Limit:")
    ...
    def on_calculate(self):
        try:
            ...
            starting_number = self.collatz_calculator.find_starting_number(limit)
            self.result_label.config(text=f"Longest Collatz sequence starts with: {starting_number}")
        except ValueError:
